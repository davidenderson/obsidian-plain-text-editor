// Identifiers and defaults shared across the plugin.
export const VIEW_TYPE = 'plain-text-editor';
export const VIEW_ICON = 'file-text';
export const DEFAULT_EXTENSIONS = 'txt';
